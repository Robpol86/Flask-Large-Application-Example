...
class HardCoded(object):
  ...
  All hard coded settings/data that are not actual/official configuration options for Flask, Celery, or their extensions
  goes here.
  """
  ADMINS = ['me@me.com']
  ...
  _SQLALCHEMY_DATABASE_PASSWORD = 'changeme'
  _SQLALCHEMY_DATABASE_USERNAME = 'changeme'
